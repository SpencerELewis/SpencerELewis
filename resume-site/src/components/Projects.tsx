...
const PROJECTS = [
    ...
    { title: "RateMyClass", description: "A MVC web application that allows users to rate and review their classes and professors.", imageDescription: "Course & instructor ratings with user accounts.", techs: ["React", "TypeScript", "C#", ".NET", "docker", "SQL Server"], image: `${BASE}cards/ratemyclass.png` },
